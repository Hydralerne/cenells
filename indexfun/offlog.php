...
<html>
<head>
<title>مرحبا بكم - CENells</title>
<meta charset="UTF-8" />
<meta name="viewport" content="width=device-width, initial-scale=1.0" />
<meta name="description" content="سينيلز هو وسيلة تواصل اجتماعي تمكن الاشخاص من التواصل مع الاشخاص الاخرين عبر نشر التدوينات المتوسطة والتفاعل معها واعادة تدوينها والتعليق عليها وغير ذلك" />
<meta name="keywords" content="سينيلز,CENells,تواصل اجتماعي,CENels,تدوينة,CE Tcenology,سنلز,CEMail,سينلز,posts" />
...
<div class="worlddescrip">
<img src="../img/world.png" class="worldimage" id="worldimage" />
</div>
<div class="leftext_change">
<div class="insetext_rotate">
<h3>
كن علي تواصل دائم بالعالم
<p>
وشارك ما يجري حولك
</p>
</h3>
...
$(document).ready(function(){
	$(".current-item").click(function(){
		...
		$(".logindiv-back,.signup-form").addClass("scale");
		setTimeout(function(){
        $(".index_body,.scrolling_main").fadeIn(250);		
        },300);
	});
	$(".login_clickli").click(function(){
		window.history.pushState("", "", '/login/');
		if($(".logindiv-back").length == 0){
		$(".index_body,.scrolling_main").fadeOut(0,function(){
        ...
        $(".all_loading_back,.index_body,.scrolling_main").fadeOut(0,function(){
        $(".signup-form").addClass("scale");
        setTimeout(function(){
	...
	$(".signup_clicki").click(function(){
        ...
        setTimeout(function(){
        $(".all_loading_back").fadeIn(250);
		$.get("../signup/signup-html.php",{gethtml: "submit"},function(e){$(".register_div").html(e)});		
		},300);
		});
		}else {
        $(".all_loading_back,.index_body,.scrolling_main").fadeOut(0,function(){
...
$(".current-item a,.login_clickli a,.signup_clicki a").click(function(event){
	event.preventDefault();
});
/*
$(document).ready(function(){
$(function() {
    $(".getlangamdmore").each(function() {
        var count = 0;
        $(this).click(function(){
        count++;
        if (count === 1) {
	    ...
	    setTimeout(function(){
		$(".getlangamdmore").css('transform','rotate(180deg)');
	    },600);
	    ...
	    setTimeout(function(){
		$(".footer").fadeOut(0);
		$(".getlangamdmore").css('transform','rotate(0deg)');
	    },600);
		count = 0;
        }
        });
