...
$from = $id;
$to = addslashes(strip_tags(htmlspecialchars(trim($_POST['id']))));
...
if(empty($idropen)){
	mysql_query("INSERT INTO chat(type,msid,from_id,to_id,online) VALUES('session','empty','$from','$to','insert')");
	echo '
<script>
doclickup();
</script>
