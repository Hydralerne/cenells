...
if($offset == "0"){
?>
<div class="ofset_followeing_4521">
<?php
}else {}
$query = mysql_query("SELECT * FROM follow WHERE follow='$use' AND follow_active='true' ORDER BY id DESC LIMIT $limit OFFSET $offset");
...
$querycounc = mysql_query("SELECT id FROM follow WHERE follow='$use' AND follow_active='true' ORDER BY id LIMIT 1");
