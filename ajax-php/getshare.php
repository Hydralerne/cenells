...
$select = mysql_query("SELECT * FROM xrede WHERE post_id='$postid' AND session='repost_secret' AND type='post_secret'");
...
$querylike = mysql_query("SELECT * FROM posts WHERE type='share' AND share_id='$postid' ORDER BY id DESC LIMIT $limit OFFSET $offset");
...
<h3>عفوا - لا تملك صلاحية لعرض الاشخاص  اللذين اعادو التدوين</h3>
...
$querycounc = mysql_query("SELECT id FROM posts WHERE type='share' AND share_id='$postid' ORDER BY id LIMIT 1");
