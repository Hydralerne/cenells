...
$select = mysql_query("SELECT * FROM xrede WHERE post_id='$postid' AND session='postlike_secret' AND type='post_secret'");
...
$querylike = mysql_query("SELECT * FROM likes WHERE post_id='$postid' AND do='like' ORDER BY id DESC LIMIT $limit OFFSET $offset");
...
<h3>عفوا - لا تملك صلاحية لعرض الاشخاص المعجبين</h3>
...
$querycounc = mysql_query("SELECT id FROM likes WHERE post_id='$postid' AND do='like' ORDER BY id LIMIT 1");
