...
if($offset == "0"){
?>
<div class="ofset_followers_4521">
<?php
}else {}
$query = mysql_query("SELECT * FROM follow WHERE following='$use' AND follow_active='true' ORDER BY id DESC LIMIT $limit OFFSET $offset");
while($fetc = mysql_fetch_assoc($query)){
$followid = $fetc['follow'];
...
?>
<div class="mini_follow_4521">
<div class="cover_back_4521" style="background-image: url('../upload/covers/mini/<?php echo $usercov; ?>');top: <?php echo $covrset; ?>px"></div>
<div class="info_follow_4521">
<img src="../upload/images/low/<?php echo $userimg; ?>" class="follow_userimg_4521" />
<a href="../<?php echo $useridm; ?>">
<span <?php if($checkui == "true"){echo 'class="followtruespan"';}else {} ?>>
<?php 
echo $usernam;
?>
</span>
<?php
if($checkui == "true"){
	echo "<img src='../img/icons/checkbg.png' class='check_4521' />";
}
?>
</a>
...
<div class="bottom_aboutfol_4521">
...
$querycounc = mysql_query("SELECT id FROM follow WHERE following='$use' AND follow_active='true' ORDER BY id LIMIT 1");
$numrowscom = mysql_result($querycounc,0);
if($empty == $numrowscom){
echo '
<script>
$(".loadmore_follow").fadeOut(0);
</script>
';
}else {
echo '
