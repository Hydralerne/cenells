...
<div class="ofset_haryfollowing_1231">
<div class="descount_follow_12312">
<?php
$selco = mysql_query("SELECT COUNT(id) FROM follow WHERE following='$id' AND follow_active='true'");
$count = mysql_result($selco,0);
?>
<span>(<a><?php echo $count; ?></a>) عدد الاشخاص اللذين يتابعونك</span>
</div>

<?php
}else {}
$query = mysql_query("SELECT * FROM follow WHERE following='$id' AND follow_active='true' ORDER BY id DESC LIMIT $limit OFFSET $offset");
...
$querycounc = mysql_query("SELECT id FROM follow WHERE following='$id' ORDER BY id LIMIT 1");
