<div class="mini_search_result">
<div class="left_search_6565">
<img src="../upload/images/low/<?php echo $fetch['pro_img']; ?>" class="searchimg_656" />
<span>
<?php 
echo '<a href="../'.$fetch['id'].'">'.$fetch['name'].'</a>'; 
if($fetch['c_check'] == "true"){
	echo '<image src="../img/icons/checkbg.png" class="check_search_6565" />';
}else {}
?>
</span>
<p>@<?php echo $fetch['user_name']; ?></p>
</div>
<div class="right_search_6565">
...
<div class="what_type_6565"><p><?php echo $acctype; ?></p></div>
<div class="accstate_6565"><p><?php echo $about; ?></p></div>
</div>
</div>